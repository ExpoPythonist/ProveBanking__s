(function() {
  ...
  humanize.numberShort = function(number) {
    if (number < 1000) {
  ...
  humanize.relativeTime = function(timestamp) {
    ...
    if (timeDiff < 60 && timeDiff > -60) {
      return (timeDiff >= 0 ? Math.floor(timeDiff) + 's' : 'in ' + Math.floor(-timeDiff) + ' seconds');
    }
    ...
    */
    ...
    if (timeDiff < 3600 && timeDiff > -3600) {
      return (timeDiff >= 0 ? Math.floor(timeDiff / 60) + 'm' : 'in ' + Math.floor(-timeDiff / 60) + ' minutes');
    }
    ...
    */
    ...
    if (timeDiff < 86400 && timeDiff > -86400) {
      return (timeDiff >= 0 ? Math.floor(timeDiff / 3600) + 'h' : 'in ' + Math.floor(-timeDiff / 3600) + ' hours');
    }
